            ...
            <div class="content">
                ...
                <div class="flex-item item-2 order-3 text-xl-right">
                    ...
                    <div>
                        ...
                        <p>
                            <a class="text-black"
                                href="tel:<?php echo clean($agent['phone']); ?>"><?php echo phoneNumberFormat($agent['phone']); ?></a><strong>
                                (Call or Text!) </strong>
                ...
                <div class="flex-item item-3 order-2">
                    ...
                    <div class="mb-2 address">
                        ...
                        <a class="text-black" target="_blank" href="<?php echo $address['direction'] ?>">
                            <?php 
                                $comm_address = $address['address']['street1'] . (($address['address']['street2'] != "") ? " " . $address['address']['street2'] : "") . ", " . $address['address']['city'] . ", " . $address['address']['state'] . " " . $address['address']['zip'];
                            ?>
...
<div class="community-flex-container">
    ...
    <section id="community-overview" class="order-<?php echo $comm['sectionOrder']['overview']; ?>">
        <div class="bg-center community-welcome"
            style="background-image: url('/communities/clarksburg-town-center/images/bg-welcome.jpg');">
                ...
                <div class="content px-lg-5">
                    ...
                    ?>
                        <h4 class="font-weight-bold m-0 py-3">
                            <?php echo ($featured_status) ? "Community Highlights" : ""; ?></h4>
                        <div class="row m-0">
                            <?php foreach ($featured['featured'] as $featured) {
