		...
		<!-- Floor Plan Detials -->
      	<div class="face back"> 
      		<div class="floorplans_details">
      			<h1>2,987 Sq.Ft | 4 Bed | 3 Full & 2 Half Ba | 2-Car Garage</h1>
      				...
      				<div class="col-6">
      					<div id="fp_slider_<?php echo $floorplane_name; ?>" class="carousel slide body-slider" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/firstfloor3.png" class="img-fluid">
                                </div>
								<!-- Third -->
                                <div class="carousel-item">
		...
		<div class="d-inline-block fp-button">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/glendale/images/main/slideShow6.jpg" alt="">
				</div>
			</div>
			<p>Floor Plans</p>
		</div>
	...
	<div class="col-7 text-right justify-content-end">
		<div class="el-button d-inline-block">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/glendale/images/main/slideShow9.jpg" alt="">
				</div>
				<div class="fp-el-image">
					<img src="/floorplans/glendale/images/main/slideShow10.jpg" alt="">
				</div>
			</div>
