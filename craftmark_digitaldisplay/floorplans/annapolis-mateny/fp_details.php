<?php $floorplane_name = "annapolis-mateny"; ?>
<!-- Floorplan Header -->
      	...
      	<div class="face front"> 
      		<div id="main_<?php echo $floorplane_name; ?>" class="carousel slide animated fadeIn main-slider" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
				    <div class="carousel-item bg-center active" style="background-image: url(/floorplans/annapolis/images/mateny-hill/slideShow1.jpg);">
				    	<a href="/floorplans/annapolis/images/mateny-hill/slideShow1.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
				    <?php for($i=2; $i<=8; $i++) { ?>
				    <div class="carousel-item bg-center" style="background-image: url(/floorplans/annapolis/images/mateny-hill/slideShow<?php echo $i; ?>.jpg);">
				    	<a href="/floorplans/annapolis/images/mateny-hill/slideShow<?php echo $i; ?>.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
				    <?php } ?>
		...
		<!-- Floor Plan Detials -->
      	<div class="face back"> 
      		<div class="floorplans_details">
      			<h1>Up to 2,450+ Sq. Ft. | 2-4 Bedrooms | 2-3 Full & 1-2 Half Baths | 2-Car Garage</h1>
      				...
      				<div class="col-6">
      					<div id="fp_slider_<?php echo $floorplane_name; ?>" class="carousel slide body-slider" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/ground1-3.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/ground1-4.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/ground1-5.png" class="img-fluid">
                                </div>
                                <!-- First -->
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/first1-1.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/first1-2.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/first1-3.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/first1-4.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/first1-5.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/first1-6.png" class="img-fluid">
                                </div>
                                <!-- Second -->
                                <div class="carousel-item">
                                ...
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/second2-1.png" class="img-fluid">
                                </div>
                                <div class="carousel-item">
		...
		<div class="d-inline-block fp-button">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/annapolis/images/mateny-hill/slideShow6.jpg" alt="">
				</div>
			</div>
			<p>Floor Plans</p>
		</div>
	...
	<div class="col-7 text-right justify-content-end">
		<div class="el-button d-inline-block">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/annapolis/images/mateny-hill/slideShow5.jpg" alt="">
				</div>
				<div class="fp-el-image">
					<img src="/floorplans/annapolis/images/mateny-hill/slideShow3.jpg" alt="">
				</div>
			</div>
