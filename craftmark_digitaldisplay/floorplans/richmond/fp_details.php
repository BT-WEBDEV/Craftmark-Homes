<?php $floorplane_name = "richmond"; ?>
<!-- Floorplan Header -->
<div class="community_name">
	<h1>The Richmond<span class="city_name"> at <?php echo $community_name; ?></span></h1>
</div>
<!-- Floorplan Details -->
<div class="flip">
      	...
      	<div class="face front"> 
      		<div id="main_<?php echo $floorplane_name; ?>" class="carousel slide animated fadeIn main-slider" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
				    <div class="carousel-item bg-center active" style="background-image: url(/floorplans/richmond/images/main/slideShow1.jpg);">
				    	<a href="/floorplans/richmond/images/main/slideShow1.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
					<?php for ($i=2; $i <=9 ; $i++) { ?>
				    <div class="carousel-item bg-center" style="background-image: url(/floorplans/richmond/images/main/slideShow<?php echo $i; ?>.jpg);">
				    	<a href="/floorplans/richmond/images/main/slideShow<?php echo $i; ?>.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
				<?php } ?>
      					...
      					<div id="fp_slider_<?php echo $floorplane_name; ?>" class="carousel slide body-slider" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/ground1.jpg" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/ground2.jpg" class="img-fluid">
                                </div>
								<!-- Second -->
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/second1.jpg" class="img-fluid">
                                </div>
								<!-- Third -->
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/third1.jpg" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/third2.jpg" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/third3.jpg" class="img-fluid">
                                </div>
                            </div>
                        </div>
      				</div>
		...
		<div class="d-inline-block fp-button">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/richmond/images/main/slideShow3.jpg" alt="">
				</div>
			</div>
			<p>Floor Plans</p>
		</div>
	...
	<div class="col-7 text-right justify-content-end">
		<div class="el-button d-inline-block">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/richmond/images/main/slideShow4.jpg" alt="">
				</div>
				<div class="fp-el-image">
					<img src="/floorplans/richmond/images/main/slideShow7.jpg" alt="">
				</div>
			</div>
