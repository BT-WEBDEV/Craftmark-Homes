<?php $floorplane_name = "arlington-mateny"; ?>
<!-- Floorplan Header -->
<div class="community_name">
	<h1>The Arlington<span class="city_name"> at <?php echo $community_name; ?></span></h1>
</div>
<!-- Floorplan Details -->
<div class="flip">
      	...
      	<div class="face front"> 
      		<div id="main_<?php echo $floorplane_name; ?>" class="carousel slide animated fadeIn main-slider" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
				    <div class="carousel-item bg-center active" style="background-image: url(/floorplans/arlington/images/main/slideShow1.jpg);">
				    	<a href="/floorplans/arlington/images/main/slideShow1.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
				    <?php for($i=2; $i<=9; $i++) { ?>
				    <div class="carousel-item bg-center" style="background-image: url(/floorplans/arlington/images/main/slideShow<?php echo $i; ?>.jpg);">
				    	<a href="/floorplans/arlington/images/main/slideShow<?php echo $i; ?>.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
				    <?php } ?>
		...
		<!-- Floor Plan Detials -->
      	<div class="face back"> 
      		<div class="floorplans_details">
      			<h1>Up to 2,800 Sq. Ft. | 3-4 Bedrooms | 2-3 Full & 1-2 Half Baths | 2-Car Garage</h1>
      				...
      				<div class="col-6">
      					<div id="fp_slider_<?php echo $floorplane_name; ?>" class="carousel slide body-slider" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <!-- Loft -->
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/loft.png" class="img-fluid">
                                </div>
                            </div>
                        </div>
      				</div>
		...
		<div class="d-inline-block fp-button">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/arlington/images/main/slideShow1.jpg" alt="">
				</div>
			</div>
			<p>Floor Plans</p>
		</div>
	...
	<div class="col-7 text-right justify-content-end">
		<div class="el-button d-inline-block">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/arlington/images/main/slideShow3.jpg" alt="">
				</div>
				<div class="fp-el-image">
					<img src="/floorplans/arlington/images/main/slideShow4.jpg" alt="">
				</div>
			</div>
