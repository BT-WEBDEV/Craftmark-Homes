    ...
    <div id="collapse_1_<?php echo $floorplane_name; ?>" class="collapse show" data-parent="#accordion_<?php echo $floorplane_name; ?>">
      <div class="card-body active_wrap">
        <ul class="list-unstyled">
          ...
          <li data-target="#fp_slider_<?php echo $floorplane_name; ?>" data-slide-to="1">Optional 4' Extension</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div id="collapse_3_<?php echo $floorplane_name; ?>" class="collapse" data-parent="#accordion_<?php echo $floorplane_name; ?>">
      <div class="card-body active_wrap">
        <ul class="list-unstyled">
          ...
          <li data-target="#fp_slider_<?php echo $floorplane_name; ?>" data-slide-to="5">Optional 4' Extension/Owner's Bath</li>
          <li data-target="#fp_slider_<?php echo $floorplane_name; ?>" data-slide-to="6">Dual Owner's Suites</li>
          <li data-target="#fp_slider_<?php echo $floorplane_name; ?>" data-slide-to="7">Optional 4' Extension/Alternate</li>
        </ul>
      </div>
    </div>
  </div>
