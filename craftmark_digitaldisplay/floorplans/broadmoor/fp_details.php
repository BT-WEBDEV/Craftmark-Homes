<?php $floorplane_name = "broadmoor"; ?>
<!-- Floorplan Header -->
<div class="community_name">
	<h1>The Broadmoor<span class="city_name"> at <?php echo $community_name; ?></span></h1>
</div>
<!-- Floorplan Details -->
<div class="flip">
      	...
      	<div class="face front"> 
      		<div id="main_<?php echo $floorplane_name; ?>" class="carousel slide animated fadeIn main-slider" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
				    <div class="carousel-item bg-center active" style="background-image: url(/floorplans/broadmoor/images/main/slideShow1.jpg);">
				    	<a href="/floorplans/broadmoor/images/main/slideShow1.jpg" class="i_<?php echo $floorplane_name; ?>">
		...
		<div class="d-inline-block fp-button">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/broadmoor/images/main/slideShow1.jpg" alt="">
				</div>
			</div>
			<p>Floor Plans</p>
		</div>
