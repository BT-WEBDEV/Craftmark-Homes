<?php $floorplane_name = "middletown-primrose"; ?>
<!-- Floorplan Header -->
<div class="community_name">
	<h1>The Middletown<span class="city_name"> at <?php echo $community_name; ?></span></h1>
</div>
<!-- Floorplan Details -->
<div class="flip">
      	...
      	<div class="face front"> 
      		<div id="main_<?php echo $floorplane_name; ?>" class="carousel slide animated fadeIn main-slider" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
				    <div class="carousel-item bg-center active" style="background-image: url(/floorplans/middletown/images/main/slideShow1.jpg);">
				    	<a href="/floorplans/middletown/images/main/slideShow1.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
					<?php for($i=2; $i<=12; $i++) { ?>
				    <div class="carousel-item bg-center" style="background-image: url(/floorplans/middletown/images/main/slideShow<?php echo $i; ?>.jpg);">
				    	<a href="/floorplans/middletown/images/main/slideShow<?php echo $i; ?>.jpg" class="i_<?php echo $floorplane_name; ?>">
				    		<img src="/craftmark_digitaldisplay/images/bg-box-big.png" alt="Craftmark Homes" class="img-fluid">
				      	</a>
				    </div>
				    <?php } ?>
		...
		<!-- Floor Plan Detials -->
      	<div class="face back"> 
      		<div class="floorplans_details">
      			<h1>2,928 Sq. Ft. | 4 Bedrooms | 2 - 3 Full & 1 Half Baths | 2-Car Garage</h1>
      					...
      					<div id="fp_slider_<?php echo $floorplane_name; ?>" class="carousel slide body-slider" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/basement.png" class="img-fluid">
                                </div>
								<!-- First -->
								...
								<!-- Second -->
                                <div class="carousel-item">
                                    <img src="/craftmark_digitaldisplay/floorplans/<?php echo $floorplane_name; ?>/fp_images/second.png" class="img-fluid">
                                </div>
                            </div>
                        </div>
      				</div>
		...
		<div class="d-inline-block fp-button">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/middletown/images/main/slideShow9.jpg" alt="">
				</div>
				<div class="fp-el-image">
					<img src="/floorplans/middletown/images/main/slideShow10.jpg" alt="">
				</div>
			</div>
			<p>Floor Plans</p>
		</div>
	...
	<div class="col-7 text-right justify-content-end">
		<div class="el-button d-inline-block">
			<div class="add-shadow d-inline-block clearfix">
				...
				<div class="fp-el-image">
					<img src="/floorplans/middletown/images/main/slideShow4.jpg" alt="">
				</div>
				<div class="fp-el-image">
					<img src="/floorplans/middletown/images/main/slideShow2.jpg" alt="">
				</div>
			</div>
