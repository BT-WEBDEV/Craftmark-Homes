	 ...
	 <div class="container-fluid d h-100 d-flex flex-column">
	 	...
	 	<div class="row">
	 		...
	 		<div class="col-md-10 custom-col-10 align-self-center community_name">
	 			<h1>Site Plan &amp; Area Map<span class="city_name"> at Clarksburg Town Center</span></h1>
	 		</div>
	 	</div>
		<!-- ///Header and Logo -->
...
$(function () {
    ...
    {
        small : 'siteplan_image/siteplan_3.jpg',
        big : 'siteplan_image/siteplan_3.jpg'
    },
    {
    ...
    {
        small : 'siteplan_image/slide17.jpg',
        big : 'siteplan_image/slide17.jpg'
    },
    {
