	 ...
	 <div class="container-fluid d h-100 d-flex flex-column">
	 	...
	 	<div class="row">
	 		...
	 		<div class="col-md-10 custom-col-10 align-self-center community_name">
	 			<h1>Included Features<span class="city_name"> at Preserve at Westfields</span></h1>
	 		</div>
	 	</div>
		<!-- ///Header and Logo -->
	 	...
	 	<div class="row h-100 features-and-about">
	 		<div class="col-md-3 text-center align-self-end">
				<ul class="list-unstyled text-left list-menu active_wrap">
					...
					<li data-target="#features-slider" data-slide-to="5">Commitment To Quality</li>
				</ul>
	 		</div>

	 		<div class="col-md-9">
				<div class="header-img">
					<img src="/craftmark_digitaldisplay/images/header.jpg" alt="" class="img-fluid">
				</div>
				<!-- Standard Features -->
