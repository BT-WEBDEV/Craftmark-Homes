...
if (isset($_POST['fbrp_setting'])) {
    /*update_option('fbrp_app_id', $_POST['fbrp_app_id']);
    update_option('fbrp_app_secret', $_POST['fbrp_app_secret']);*/
...
$fbrp_app_id = get_option('fbrp_app_id');
$fbrp_app_secret = get_option('fbrp_app_secret');
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane<?php if ($fbrp_setting_page) { ?> active<?php } ?>" id="setting">
            ...
            <?php wp_nonce_field('fbrp-wpnonce_fbrp_settings', 'fbrp-form_nonce_fbrp_settings'); ?>
                ...
                <?php } ?>
                <!--div class="form-group">
                    <label class="control-label" for="fbrp_app_id"><?php echo fbrp_i('App ID'); ?></label>
                    <input class="form-control" type="text" id="fbrp_app_id" name="fbrp_app_id" value="<?php echo esc_attr($fbrp_app_id); ?>">
                </div>
                <div class="form-group">
                    <label class="control-label" for="fbrp_app_secret"><?php echo fbrp_i('App Secret'); ?></label>
                    <input class="form-control" type="text" id="fbrp_app_secret" name="fbrp_app_secret" value="<?php echo esc_attr($fbrp_app_secret); ?>">
                </div>
                <div class="form-group">
        ...
        <div role="tabpanel" class="tab-pane" id="shortcode">
            ...
            //if ($fbrp_app_id && $fbrp_app_secret) {
            ...
            /*} else {
                ...
                ?>
                <p>Firstly, please configure 'App ID' and 'App Secret' on the <a href="#setting" aria-controls="setting" role="tab" data-toggle="tab">setting page</a></p>
                <?php
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function($) {
                    ...
                    var fbrev_init_async = function(attempts) {
                            ...
                            fbrev_init({
                                widgetId: 'shortcode',
                                /*appId: '<?php echo $fbrp_app_id; ?>',
                                appSecret: '<?php echo $fbrp_app_secret; ?>',*/
