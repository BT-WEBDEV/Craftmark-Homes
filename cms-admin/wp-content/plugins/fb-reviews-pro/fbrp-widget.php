...
class Fb_Reviews_Widget_Pro extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if (fbrp_enabled()) {
            ...
            echo $before_widget;
            $response = fbrp_api_rating($page_id, $page_access_token, $instance, $this->id, $cache, $api_ratings_limit, $show_success_api);
    ...
    function form($instance) {
        ...
        if ($fbrp_app_id && $fbrp_app_secret) {
            ...
            <div id="<?php echo $this->id; ?>" class="rplg-widget">
                ...
                ?>
                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-widget-id="<?php echo $this->id; ?>" data-app-id="<?php echo $fbrp_app_id; ?>" data-app-secret="<?php echo $fbrp_app_secret; ?>" onload="fbrev_init({widgetId: this.getAttribute('data-widget-id'), appId: this.getAttribute('data-app-id'), appSecret: this.getAttribute('data-app-secret')})" style="display:none">
            </div>
            <?php
            ...
            ?>
            <p>Firstly, please configure 'App ID' and 'App Secret' on the <a href="<?php echo admin_url('options-general.php?page=fbrp'); ?>">setting page</a></p>
            <?php
        }*/
