...
define('FBRP_AVATAR',             FBRP_PLUGIN_URL . '/static/img/avatar.png');
...
function fbrp_shortcode($atts) {
    ...
    $response = fbrp_api_rating($page_id, $page_access_token, $atts, 'shortcode2', $cache, $limit, $show_success_api);
...
function fbrp_api_rating($page_id, $page_access_token, $options, $cache_name, $cache_option, $limit, $show_success_api) {
    ...
    if ($show_success_api) {
        $response_cache_key_success = 'fbrp_' . $cache_name . '_suc_api_' . $page_id;
