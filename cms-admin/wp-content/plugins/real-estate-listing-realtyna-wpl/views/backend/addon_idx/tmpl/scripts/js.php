...
<script type="text/javascript">
    wplj(document).ready(function()
    {
        ...
        wplj(document).on('click','#text_only',function(){
            if(wplj(this).is(':checked'))
            {
                wplj(this).parents('.wpl-idx-addon-table-row').find('#text_image').removeAttr('checked');
            }
        });
        wplj(document).on('click','#text_image',function(){
            if(wplj(this).is(':checked'))
            {
                wplj(this).parents('.wpl-idx-addon-table-row').find('#text_only').removeAttr('checked');
            }
        });
    });
    ...
    function wpl_idx_generate_config_form(property_types)
    {
        ...
        config_form +='</div>';
        config_form +='<div class="wpl-small-12 wpl-medium-6 wpl-large-6 wpl-column" style="display:none;">';
        config_form +='<div class="wpl-idx-form-checkbox">';
        config_form +='<input id="text_image" type="checkbox" class="yesno">';
        config_form += '<?php echo __('Download text and image to your server', 'real-estate-listing-realtyna-wpl')?>';
        config_form += '<span class="wpl-idx-form-field-subtitle"><?php echo __('Note:this will increase your hosting load', 'real-estate-listing-realtyna-wpl')?></span>';
        config_form +='</div>';
        config_form +='<div class="wpl-idx-form-checkbox">';
        config_form +='<input id="text_only" type="checkbox" class="yesno">';
        config_form += '<?php echo __('Download only text to your server', 'real-estate-listing-realtyna-wpl')?>';
        config_form += '<span class="wpl-idx-form-field-subtitle"><?php echo __('Prefered for IDX subscribers', 'real-estate-listing-realtyna-wpl')?></span>';
        config_form +='</div>';
